...
$(document).ready(function() {
    ...
    var t2 = io.connect('tier2.limaea.com');
        
    t2.on('connect', function(){
...
function processTierData(){
    ...
    var tier1Val = 4000 - totalTier1Time - (totalTier1Count *5);
    var tier2Val = 4000 - totalTier2Time - (totalTier2Count *5);
